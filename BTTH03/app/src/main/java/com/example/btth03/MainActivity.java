...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        studentAdapter = new Adapter(studentList, this, student -> {
        ...
        fabAddStudent.setOnClickListener(v -> {
            ...
            new AddStudent(this, studentAdapter, studentList, this).show();
        });
    }
    ...
    private void loadJSONData() {
        try {
            ...
            Student2 students = gson.fromJson(reader, Student2.class);
    ...
    public void saveToInternalStorage() {
        try {
            ...
            Gson gson = new Gson();
            String json = gson.toJson(new Student2(studentList));
